...
const checkPermissions = (member: GuildMember): boolean => {
    return checkCommandPermissions(
        member,
        settings.commands?.lock as LockCommandSettings,
...
export const command: Command = {
    name: 'lock',
    aliases: settings.commands?.lock?.aliases || [],
    enabled: settings.commands?.lock?.enabled ?? true,
